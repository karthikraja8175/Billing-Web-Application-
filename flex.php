...
<html>
     ...
     <img onclick="window.location.href='flex.html';" class="back1" value="click" src="images/back.png"> 
...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO flex (date, size, cusname, location, amount) VALUES ('$date', '$size', '$cusname', '$location', '$amount')";

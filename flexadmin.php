...
<body style="background-color:rgb(201, 201, 202);">
    ...
    <h1>
           ...
           if(isset($_GET['from_date']) && isset($_GET['to_date']))
           {
               ...
               $query = "SELECT * FROM flex WHERE date BETWEEN '$from_date' AND '$to_date' ";
               ...
               if(mysqli_num_rows($query_run) > 0){
                    ...
                    echo '<h1>';
                    echo "no FLEX sales on this days";
                    echo "<br>";
                    echo '</h1>';
                    echo '</div>';
               }
                $sql = "SELECT  SUM(amount) from flex WHERE date BETWEEN '$from_date' AND '$to_date' ";
